...
Available tools:
  ...
  flag_merchant(input_text) — Flag a suspicious merchant and save it to flagged_merchants.json
"""
...
""")
    ...
    def tool_flag_merchant(input_text: str):
        import json
        from pathlib import Path
        from datetime import datetime

        merchant_id, reason = input_text.split(",", 1)
        ...
        output_file = Path("agent_outputs/flagged_merchants.json")
        ...
        return f"Merchant {merchant_id.strip()} flagged: {reason.strip()}"
