...
incident_reporter = Agent(
    ...
    goal="Generate concise Slack alerts for data quality incidents",
    backstory="""
    You are a senior incident communications specialist.

    You have repeatedly been criticized for writing long reports.

    You only write concise, actionable Slack messages.
...
*Top fix:* <most urgent action>
*Next review:* <tomorrow>

Keep it concise.
""",
    expected_output="Slack notification",
    context=[task_guardian],
    agent=incident_reporter,
    output_file="agent_outputs/slack_notification.txt"
)
# ── Crew ──────────────────────────────────────────────────────────────────────
dq_crew = Crew(
