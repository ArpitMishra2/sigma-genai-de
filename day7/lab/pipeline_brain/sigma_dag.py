...
def extract_bronze(**context):
    ...
    # Implement CSV to Parquet transformation logic here
    logging.info(f"Completed extract_bronze task")
...
def transform_silver(**context):
    ...
    # Implement data cleaning, enrichment, and deduplication logic here
    logging.info(f"Completed transform_silver task")
    raise Exception("Simulated failure")  # For testing failure handling
...
def build_gold(**context):
    ...
    logging.info(f"Completed build_gold task")
    raise Exception("Simulated failure")  # For testing failure handling
